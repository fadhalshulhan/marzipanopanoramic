    ...
    return function r(n, o, s) {
            ...
            r = this, n = function () {
                return r = {}, n.m = i = {
                    17: function (t, e, i) {
                        ...
                        var r = i(18),
                            i = (u.getFirstMatch = function (t, e) {
                                ...
                                for (var i = t, e = arguments.length, r = new Array(1 < e ? e - 1 : 0), n = 1; n < e; n++) r[n - 1] = arguments[n];
                                if (Object.assign) return Object.assign.apply(Object, [t].concat(r));
                                for (var o = 0, s = r.length; o < s; o += 1) ! function () {
                                    var e = r[o];
                    ...
                    90: function (t, e, i) {
                        ...
                        var s, a, a = (u.getParser = function (t, e) {
                    ...
                    91: function (t, e, i) {
                        ...
                        function a(t) {
                            ...
                            if (Object.keys(i).forEach(function (t) {
                                    var e = i[t];
                                    "string" == typeof e ? (o[t] = e, s += 1) : "object" == typeof e && (r[t] = e, n += 1)
                                }), 0 < n) {
                                var t = Object.keys(r),
                ...
                var i, r
            }, "object" == typeof i && "object" == typeof e ? e.exports = n() : "object" == typeof i ? i.bowser = n() : r.bowser = n()
        }, {}],
        2: [function (t, e, i) {
            "use strict";
        ...
        7: [function (t, e, i) {
            ...
            Object.defineProperty(i, "__esModule", {
                ...
                var r, n, o, s, a, u, h, l, c, p, f, d = i[0],
                    m = i[1],
                    v = i[2];
                ...
                var n, o, s, a, u, h, l, c, p, f, d, m, v, _, y, g, M, w, b, x = r[0],
                    E = r[1],
                    P = r[2],
                    S = Math.hypot(x, E, P);
        ...
        8: [function (t, e, i) {
            ...
            o = o.equals;
            i.equals = o;
            var M, w, b, o = (M = n.create(), w = n.fromValues(1, 0, 0), b = n.fromValues(0, 1, 0), function (t, e, i) {
                var r = n.dot(e, i);
            ...
            i.rotationTo = o;
            var x, E, o = (x = h(), E = h(), function (t, e, i, r, n, o) {
                return m(x, e, n, o), m(E, i, r, o), m(t, x, E, 2 * o * (1 - o)), t
            });
            i.sqlerp = o;
            var P, r = (P = r.create(), function (t, e, i, r) {
        ...
        13: [function (t, qt, e) {
            ! function (t, a, h) {
                ...
                function p(t, e, i) {
                    for (var r = Object.keys(e), n = 0; n < r.length;)(!i || i && t[r[n]] === h) && (t[r[n]] = e[r[n]]), n++;
                    return t
                }
                ...
                function v(t, e) {
                    return typeof t == i ? t.apply(e && e[0] || h, e) : t
                }
                    ...
                    i.isFirst = !!o, i.isFinal = !!n, o && (t.session = {}), i.eventType = e,
                        function (t, e) {
                            ...
                            var o = i.firstInput,
                                ...
                                a = (s || o).center,
                                n = e.center = Q(r);
                            e.timeStamp = u(), e.deltaTime = e.timeStamp - o.timeStamp, e.angle = tt(a, n), e.distance = $(a, n),
                                function (t, e) {
                                    var i = e.center,
                                        r = t.offsetDelta || {},
                                        n = t.prevDelta || {},
                    ...
                    handler: function (t) {
                        var e = pt[t.type],
                            i = function (t, e) {
                                ...
                                n = 0;
                                for (; n < s.length;) r[s[n].identifier] && a.push(s[n]), e & (D | j) && delete r[s[n].identifier], n++;
                ...
                Ot.prototype = {
                    ...
                    recognize: function (t) {
                        ...
                        if (!i.stopped) {
                            ...
                            for (var o = 0; o < r.length;) e = r[o], 2 === i.stopped || n && e != n && !e.canRecognizeWith(n) ? e.reset() : e.recognize(t), !n && e.state & (Pt | St | Tt) && (n = i.curRecognizer = e), o++
                        }
                    },
                    get: function (t) {
                    ...
                    bindFn: m,
                    prefixed: S
                }), typeof Wt == i && Wt.amd ? Wt(function () {
                    return Ht
            ...
            n.prototype.search = function (t, e, i) {
                ...
                for (this._clear(), r.push(e); 0 < r.length;) {
                    ...
                    if (!n.has(a) && t.intersects(a.vertices(o))) {
                        n.add(a);
                        for (var u = a.neighbors(), h = 0; h < u.length; h++) r.push(u[h]);
                        i.push(a), s++
                    }
                }
        ...
        24: [function (t, e, i) {
            ...
            w.prototype.switchScene = function (e, t, i) {
                ...
                if (o !== e) {
                    ...
                    for (var n = null != t.transitionDuration ? t.transitionDuration : 1e3, u = null != t.transitionUpdate ? t.transitionUpdate : b, h = 0; h < a.length; h++) this._addLayerToStage(a[h]);
        ...
        34: [function (t, e, i) {
            ...
            e.exports = {
                ...
                applyToImageData: function (t, e) {
                    for (var i = t.width, r = t.height, n = t.data, o = 0; o < i * r; o++) u.set(a, n[4 * o + 0] / 255, n[4 * o + 1] / 255, n[4 * o + 2] / 255, n[4 * o + 3] / 255), s(a, e, a), n[4 * o + 0] = 255 * a[0], n[4 * o + 1] = 255 * a[1], n[4 * o + 2] = 255 * a[2], n[4 * o + 3] = 255 * a[3]
                }
            }
        }, {
            "gl-matrix": 3
        ...
        45: [function (t, e, i) {
            ...
            r(u), u.prototype.destroy = function () {
                ...
                for (var i = 0, r = 0; r < this._eventList.length; r++) i += h(this._eventList[r]) * this._opts.zoomDelta / this._opts.frictionTime;
            ...
            S.prototype.rotX = function () {
                ...
                for (var o = 0; o < f.length; o++)
                    for (var s = f[o], a = 0; a <= r; a++)
                        for (var u = 0; u <= n; u++) e.push(new S(s, a, u, i, this));
                return e
                ...
                for (var a = Math.max(Math.abs(i[0]), Math.abs(i[1]), Math.abs(i[2])) / .5, u = 0; u < 3; u++) i[u] = i[u] / a;
                var h = M[o];
                w(i, 0, -h.x, -h.y);
                ...
                if (!(o <= 0 || s <= 0)) {
                    ...
                    for (t = 0; t < this._layers.length; t++) {
                        ...
                        if (_(o, s, p && p.rect, a), !(a.width <= 0 || a.height <= 0)) {
                            for (u.width = a.width * this._width, u.height = a.height * this._height, f.setSize(u), m.startLayer(c, a), f = this._collectTiles(c, d), e = 0; e < i.length; e++) h = i[e], d.markTile(h);
                            for (e = 0; e < r.length; e++) h = r[e], l = d.texture(h), m.renderTile(h, l, c, v);
